...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      {
        "name": "creator-cube-monorepo",
        "reference": "workspace:."
      },
      {
        "name": "multiplatform",
        "reference": "workspace:packages/multiplatform"
      },
      {
        "name": "server",
    ...
    "fallbackExclusionList": [
      ["creator-cube-monorepo", ["workspace:."]],
      ["multiplatform", ["workspace:packages/multiplatform"]],
    ...
    "packageRegistryData": [
      ...
      ["multiplatform", [
        ["workspace:packages/multiplatform", {
          "packageLocation": "./packages/multiplatform/",
          "packageDependencies": [
            ["multiplatform", "workspace:packages/multiplatform"],
            ["chalk", "npm:4.1.1"]
          ],
